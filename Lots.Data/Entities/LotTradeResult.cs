...
public class LotTradeResult
{
    ...
    /// <summary>
    /// Тип сообщения Федресурса: "Торги не состоялись", "Результаты торгов", "Отмена торгов",
    /// "Торги приостановлены", "О завершении торгов вследствие оставления конкурсным кредитором предмета залога за собой" и т.д.
    /// </summary>
