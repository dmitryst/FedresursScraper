...
{
  "canonical": "Chery",
  "aliases": ["CHERRY", "Chery", "ЧЕРИ", "ЧЕРРИ"],
  "models": [
    {
      "canonical": "Tiggo 7",
      "aliases": ["Tiggo7", "TIGGO 7", "Тигго 7"]
    }
  ]
}
```
...
- **canonical** — то, что попадёт в `brand` / `model` и в выпадающие списки
- **aliases** — все известные варианты из объявлений и ответов DeepSeek
