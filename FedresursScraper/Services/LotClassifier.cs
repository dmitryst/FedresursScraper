    ...
    public async Task<LotClassificationResult?> ClassifyLotAsync(string lotDescription)
    {
        ...
        var messages = new List<ChatMessage>
        {
            ...
            new UserChatMessage(
                ...
                "Если лот относится к товарно материальным ценностям (ТМЦ), но его не удалось определить ни к одной из \n" +
                "указанных категорий, то такой лот следует отнести к категории \"Другие ТМЦ\". \n" +
                "Если для лота не удалось определить подходящую категорию, в том числе \"Другие ТМЦ\", то \n" +
                "такому лоту, следует присвоить категорию \"Прочее\". \n\n" +
                "2. Из описания лота необходимо сформировать его название. Название должно содержать только самые \n" +
                "важные характеристики лота, подходящие под его категорию. Если это доля, то в описании это должно быть указано. \n" +
